...
const AddKnowledgeModal = ({
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-150 bg-[#0E0E12] border border-white/10 text-zinc-100 p-0 overflow-hidden gap-0">
        ...
        >
          <div className="px-6 border-b border-white/10">
            <TabsList className="bg-transparent h-auto p-0 gap-6">
              <TabsTrigger
                value="website"
                className="hover:text-zinc-300 data-active:bg-transparent data-active:shadow-none data-active:border-b-2 data-active:border-indigo-500 rounded-none px-0 py-3 text-xs uppercase tracking-wider text-zinc-500 data-active:text-white transition-all focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none ring-0 outline-none border-t-0 border-x-0"
              >
                Website
              </TabsTrigger>
              <TabsTrigger
          ...
          <div className="p-6 min-h-50 space-y-4">
            ...
            <TabsContent value="upload" className="mt-0 space-y-4">
              ...
              />
              <div
                className="border-2 border-dashed border-white/10 rounded-xl h-60 flex flex-col justify-center items-center space-y-2"
                onClick={() => {
          ...
          <div className="p-6 border-t border-white/5 bg-black/20 flex justify-end gap-3">
            ...
            <Button
              className={`bg-white min-w-[110px] text-black hover:bg-zinc-200 ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
