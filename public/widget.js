(function () {
  try {
    ...
    if (!widgetId) {
      console.error("Chatbot Support missing data-id");
      return;
    }
    ...
    fetch("http://localhost:3000/api/widget/session", {
      ...
      .catch(function (error) {
        console.error("[Chatbot Support] Failed to load widget:", error);
      });
  } catch (error) {
    console.error("[Chatbot Support] Widget Error:", error);
  }
})();
